...
A Streamlit web application for generating properly formatted Swara notation
"""
...
def render_header():
    ...
    **Notation Rules:**
    ...
    - **Tivra** (sharp): Vertical bar above note — applicable only to MA
...
def render_single_note_generator():
    ...
    with col3:
        ...
        tivra = st.checkbox(
            ...
            key='single_tivra',
            help="Only MA can be tivra" if not tivra_enabled else "Add vertical bar above note"
        )
...
def render_reference_guide():
    ...
    with st.expander("📚 Notation Reference Guide"):
        ...
        - **Vertical bar** (above text): Tivra (sharp) — half semitone higher
        ...
        MA_t        → Tivra MA (vertical bar above)
